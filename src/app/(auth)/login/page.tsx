    ...
    <div className="flex min-h-screen items-center justify-center bg-vela-white px-4 max-w-md mx-auto">
      <div className="w-full max-w-sm space-y-8">
        ...
        <button
          ...
          className="flex w-full items-center justify-center gap-3 rounded-lg border border-parchment bg-cream py-2.5 font-sans text-sm text-ink transition-colors hover:bg-parchment"
        >
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="font-sans text-xs text-stone">or</span>
          <div className="h-px flex-1 bg-parchment" />
        </div>
